<%@page import="com.posproject.jspweb.dao.jdbc.JdbcSellerInformationDao"%>
<%@page import="com.posproject.jspweb.dao.SellerInformationDao"%>
<%@page import="com.posproject.jspweb.entity.SellerInformation"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    
  <%
  
  SellerInformation aa = new SellerInformation();
  
  SellerInformationDao sellerInformation = new JdbcSellerInformationDao(); 
  aa= sellerInformation.get("a"); 
  System.out.println(aa.getStoreName());
  %>

 
  <%-- <%
  SellerInformation aa = new SellerInformation("a","a","a",55,"a");
  
  SellerInformationDao sellerInformation = new JdbcSellerInformationDao(); 
  sellerInformation.insert(aa);
  %> --%>
